#
#  Be sure to run `pod spec lint SwiftMarshal.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Jonas Zaugg"
  # s.authors            = { "Jonas Zaugg" => "jonas.zaugg@yahoo.com" }
  # s.social_media_url   = "http://twitter.com/Jonas Zaugg"
  ...
  s.source       = { :git => "https://github.com/thebluepotato/SwiftMarshal.git", :branch => "master" }
